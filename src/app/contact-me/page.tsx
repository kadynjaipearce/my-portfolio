...
export default function page() {
  return (
    <div>
      <section className="min-h-screen px-2 bg-white dark:bg-gray-900 md:px-0">
        <div className="lg:flex lg:items-center lg:-mx-10">
          <div className="lg:w-1/2 lg:mx-10">
            <h1 className="text-3xl font-semibold text-gray-800 capitalize dark:text-white lg:text-3xl">
              Let’s talk
            </h1>
